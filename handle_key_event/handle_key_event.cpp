...
public:
    Widget(WRenderer *renderer) {
        ...
        arr_texture[KEY_PRESS_SURFACE_DEFAULT].reset(renderer->generate_texture(&surface_default));
        WBMPSurface surface_down(PRO_DIR + "/handle_key_event/down.bmp");
        arr_texture[KEY_PRESS_SURFACE_DOWN].reset(renderer->generate_texture(&surface_down));
        WBMPSurface surface_up(PRO_DIR + "/handle_key_event/up.bmp");
        arr_texture[KEY_PRESS_SURFACE_UP].reset(renderer->generate_texture(&surface_up));
        WBMPSurface surface_left(PRO_DIR + "/handle_key_event/left.bmp");
        arr_texture[KEY_PRESS_SURFACE_LEFT].reset(renderer->generate_texture(&surface_left));
        WBMPSurface surface_right(PRO_DIR + "/handle_key_event/right.bmp");
        arr_texture[KEY_PRESS_SURFACE_RIGHT].reset(renderer->generate_texture(&surface_right));
